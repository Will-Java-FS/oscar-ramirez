...
public class Actor {
    ...
    // Not putting Column is OK so long as there isn't anything else to specify
    private int worth;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getId(), getName(), getAge(), getWorth(), movies);
    }
}
