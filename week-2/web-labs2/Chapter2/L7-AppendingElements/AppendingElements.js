 ...
 * you must create the element, 
 * set its attributes, 
 * and then append it to an existing element on the page. 
 * 
 * For instance, if you were appending an <img> element with some src attribute to a div named
...
function addItem(){
    ...
    listItemElement.innerHTML = input.value;
